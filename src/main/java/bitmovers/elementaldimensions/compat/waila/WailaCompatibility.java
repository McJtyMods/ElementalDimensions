package bitmovers.elementaldimensions.compat.waila;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void register(){
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendMessage("Waila", "register", "bitmovers.elementaldimensions.compat.waila.WailaCompatibility.load");
    }
