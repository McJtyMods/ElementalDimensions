...
public class EntityGhostBoss extends EntityFlying implements IMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityGhostBoss.class, DataSerializers.BOOLEAN);
    public static final ResourceLocation LOOT = new ResourceLocation(ElementalDimensions.MODID, "entities/ghost_boss");
    ...
    public EntityGhostBoss(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(7, new EntityGhostBoss.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase {
        private final EntityGhostBoss parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntityGhostBoss ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityGhostBoss ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityGhostBoss ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class GhostMoveHelper extends EntityMoveHelper {
        ...
        public GhostMoveHelper(EntityGhostBoss ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
