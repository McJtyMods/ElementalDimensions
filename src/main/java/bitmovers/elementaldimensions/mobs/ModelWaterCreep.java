...
public class ModelWaterCreep extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        EntityWaterCreep entityWaterCreep = (EntityWaterCreep) entityIn;
        float f = ageInTicks - (float) entityWaterCreep.ticksExisted;
        ...
        float f1 = (1.0F - entityWaterCreep.getSpikesAnimation(f)) * 0.55F;
        ...
        if (entityWaterCreep.hasTargetedEntity()) {
            entity = entityWaterCreep.getTargetedEntity();
        }
        ...
        float f2 = entityWaterCreep.getTailAnimation(f);
