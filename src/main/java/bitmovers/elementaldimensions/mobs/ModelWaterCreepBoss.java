...
public class ModelWaterCreepBoss extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        float f1 = (1.0F - entityWaterCreepBoss.getSpikesAnimation(f)) * 0.55F;
        ...
        if (entityWaterCreepBoss.hasTargetedEntity()) {
            entity = entityWaterCreepBoss.getTargetedEntity();
        }
        ...
        float f2 = entityWaterCreepBoss.getTailAnimation(f);
