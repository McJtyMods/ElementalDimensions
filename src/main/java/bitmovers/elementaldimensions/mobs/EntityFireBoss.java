...
public class EntityFireBoss extends EntityFlying implements IMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityFireBoss.class, DataSerializers.BOOLEAN);
    public static final ResourceLocation LOOT = new ResourceLocation(ElementalDimensions.MODID, "entities/fire_boss");
    ...
    protected void initEntityAI() {
        this.tasks.addTask(5, new EntityFireBoss.AIRandomFly(this));
        this.tasks.addTask(7, new EntityFireBoss.AILookAround(this));
        this.tasks.addTask(7, new EntityFireBoss.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase {
        private final EntityFireBoss parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntityFireBoss ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityFireBoss ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityFireBoss ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class GhostMoveHelper extends EntityMoveHelper {
        ...
        public GhostMoveHelper(EntityFireBoss ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
