...
public class EntityGhost extends EntityFlying implements IMob {
    ...
    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityGhost.class, DataSerializers.BOOLEAN);
    public static final ResourceLocation LOOT = new ResourceLocation(ElementalDimensions.MODID, "entities/ghost");
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(7, new EntityGhost.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase {
        ...
        public AIFireballAttack(EntityGhost ghast) {
...
//                    world.playEvent(null, 1016, new BlockPos(this.parentEntity), 0);
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityGhost ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityGhost ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class GhostMoveHelper extends EntityMoveHelper {
        ...
        public GhostMoveHelper(EntityGhost ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
